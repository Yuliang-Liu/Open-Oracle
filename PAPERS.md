...
- [Knowledge Resources and Digital Humanities](#knowledge-resources-and-digital-humanities)
- [Datasets for Recognition and Classification](#datasets-for-recognition-and-classification)
- [Datasets for Decipherment, Evolution, and Multimodal Understanding](#datasets-for-decipherment-evolution-and-multimodal-understanding)
- [Benchmarks for Retrieval, Rejoining, Association, and Restoration](#benchmarks-for-retrieval-rejoining-association-and-restoration)
- [Decipherment with Human Knowledge and Retrieval](#decipherment-with-human-knowledge-and-retrieval)
- [Decipherment with Generation and Diffusion](#decipherment-with-generation-and-diffusion)
- [Multimodal Reasoning, LMMs, and Agents](#multimodal-reasoning-lmms-and-agents)
- [Recognition, Classification, and Radical Modeling](#recognition-classification-and-radical-modeling)
- [Representation Learning and Domain Adaptation](#representation-learning-and-domain-adaptation)
- [Long-Tail, Open-Set, and Category Discovery](#long-tail-open-set-and-category-discovery)
- [Detection](#detection)
- [Segmentation and Component Analysis](#segmentation-and-component-analysis)
- [Retrieval and Literature Search](#retrieval-and-literature-search)
- [Rejoining, Bone Association, and Duplicate Discovery](#rejoining-bone-association-and-duplicate-discovery)
- [Restoration, Inpainting, and Denoising](#restoration-inpainting-and-denoising)
- [Augmentation and Generation](#augmentation-and-generation)
...
## Knowledge Resources and Digital Humanities

| Resource or Paper | Venue and Year | Focus | Links |
| :--- | :---: | :--- | :--- |
...
| InteChar: A Unified Oracle Bone Character List for Ancient Chinese Language Modeling | AAAI 2026, arXiv 2025 | Unified character list for ancient Chinese language modeling | [Paper](https://ojs.aaai.org/index.php/AAAI/article/view/36981), [arXiv](https://arxiv.org/abs/2508.15791) |

## Datasets for Recognition and Classification
...
## Datasets for Decipherment, Evolution, and Multimodal Understanding
...
| PictOBI-20k: Unveiling Large Multimodal Models in Visual Decipherment for Pictographic Oracle Bone Characters | ICASSP 2026, arXiv 2025 | 20k OBC-object image pairs and 15k+ multi-choice questions | [IEEE](https://ieeexplore.ieee.org/document/11462601), [arXiv](https://arxiv.org/abs/2509.05773), [Code](https://github.com/OBI-Future/PictOBI-20k) |

## Benchmarks for Retrieval, Rejoining, Association, and Restoration

| Dataset or Benchmark | Venue and Year | Task and Data | Links |
| :--- | :---: | :--- | :--- |
...
| RCRN: Real-world Character Image Restoration Network via Skeleton Extraction | ACM MM 2022 | Noisy character restoration benchmark and method | [Paper](https://dl.acm.org/doi/10.1145/3503161.3548344), [Code](https://github.com/daqians/Noisy-character-image-benchmark) |

## Decipherment with Human Knowledge and Retrieval
...
## Decipherment with Generation and Diffusion
...
## Multimodal Reasoning, LMMs, and Agents
...
## Recognition, Classification, and Radical Modeling
...
## Long-Tail, Open-Set, and Category Discovery
...
## Retrieval and Literature Search
...
## Restoration, Inpainting, and Denoising
