...
> Last updated: 2026-06-06. This file is a task-oriented bibliography for AI-assisted oracle bone inscription (OBI) / oracle bone script (OBS) processing. PRs are welcome.

## Contents

- [Surveys, Position Papers, and Knowledge Resources](#surveys-position-papers-and-knowledge-resources)
- [Datasets and Benchmarks](#datasets-and-benchmarks)
- [Decipherment, Interpretation, and LMM/Agent Systems](#decipherment-interpretation-and-lmmagent-systems)
...
- [Ancient Script / Chinese Character Evolution Beyond OBI](#ancient-script--chinese-character-evolution-beyond-obi)

## Surveys, Position Papers, and Knowledge Resources

| Paper / Resource | Venue & Year | Focus | Links |
| :--- | :---: | :--- | :--- |
...
| Dataset / Paper | Venue & Year | Task / Data | Links |
| :--- | :---: | :--- | :--- |
...
| Toward Zero-shot Character Recognition: A Gold Standard Dataset with Radical-level Annotations | ACM MM 2023 | Radical-level annotations / zero-shot | [Paper](https://arxiv.org/abs/2308.00655) |
...
| An Open Dataset for Oracle Bone Character Recognition and Decipherment | Scientific Data 2024 | HUST-OBC recognition/decipherment dataset | [Paper](https://www.nature.com/articles/s41597-024-03807-x) / [Code](https://github.com/Pengjie-W/HUST-OBC) / [Data](https://figshare.com/s/8a9c0420312d94fc01e3) |
...
| ROBC: A Radical-Level Oracle Bone Character Dataset | PRCV 2024/2025 | Radical-level dataset | [Paper](https://doi.org/10.1007/978-981-97-8511-7_8) |
...
| Pictographic Decipherment OBS Dataset (PD-OBS) | arXiv 2025 | Radical/pictographic annotations for LVLM decipherment | [Paper](https://arxiv.org/abs/2508.10113) / [Code](https://github.com/PKXX1943/PD-OBS) |
...
## Decipherment, Interpretation, and LMM/Agent Systems

| Paper / Project | Venue & Year | Focus | Links |
| :--- | :---: | :--- | :--- |
| Deciphering Ancient Chinese Oracle Bone Inscriptions Using Case-Based Reasoning | ICCBR 2021 | Case-based reasoning / multi-font retrieval | [Paper](https://doi.org/10.1007/978-3-030-86957-1_21) |
...
| Diff-Oracle: Deciphering Oracle Bone Scripts with Controllable Diffusion Model | arXiv 2023 / ACM TOMM 2026 | Diffusion-based OBI generation/decipherment | [arXiv](https://arxiv.org/abs/2312.13631) / [Paper](https://dl.acm.org/doi/abs/10.1145/3806389) |
...
| Puzzle Pieces Picker: Deciphering Ancient Chinese Characters with Radical Reconstruction | ICDAR 2024 Oral | Radical/stroke reconstruction | [arXiv](https://arxiv.org/abs/2406.03019) / [Code](https://github.com/Pengjie-W/Puzzle-Pieces-Picker) |
...
| A Text-Image Dual Conditional Stable Diffusion Model for Oracle Bone Inscription Decipherment | npj Heritage Science 2025 | Dual visual/semantic conditional diffusion | [Paper](https://www.nature.com/articles/s40494-025-02019-9) |
| OracleFusion: Assisting the Decipherment of Oracle Bone Script with Structurally Constrained Semantic Typography | ICCV 2025 | MLLM + vectorized semantic typography | [Paper](https://openaccess.thecvf.com/content/ICCV2025/html/Li_OracleFusion_Assisting_the_Decipherment_of_Oracle_Bone_Script_with_Structurally_ICCV_2025_paper.html) / [Code](https://github.com/lcs0215/OracleFusion) |
| Interpretable Oracle Bone Script Decipherment through Radical and Pictographic Analysis with LVLMs | arXiv 2025 | Interpretable LVLM decipherment / PD-OBS | [arXiv](https://arxiv.org/abs/2508.10113) / [Code](https://github.com/PKXX1943/PD-OBS) |
...
| AlphaOracle: Oracle Bone Script Decipherment via Human-Workflow-Inspired Deep Learning | Project 2025 | Multi-stage decipherment workflow | [Code](https://github.com/Yuliang-Liu/AlphaOracle) |
| Specializing Large Models for Oracle Bone Script Interpretation via Component-Grounded Multimodal Knowledge Augmentation | arXiv 2026 | Component-grounded multimodal RAG / OB-Radix | [arXiv](https://arxiv.org/abs/2604.06711) / [OpenReview](https://openreview.net/forum?id=hCVGAnQ7eE) |
...
| Can Neural Networks Learn the Pictographic Nature of Oracle Bone Script? | SSRN 2026 | Pictographic nature / neural-network analysis | [Preprint](https://doi.org/10.2139/ssrn.6271072) |
| Explainable Oracle Bone Script Recognition via Multimodal Pictographic Reasoning | AAAI 2026 | Explainable MLLM recognition/interpretation | [Paper](https://ojs.aaai.org/index.php/AAAI/article/view/41296) |
| Human--Computer Collaborative Approach to the Decipherment of Oracle Bone Inscriptions with Generative Adversarial Networks | npj Heritage Science 2026 | Image-to-image translation / human-computer collaboration | [Paper](https://www.nature.com/articles/s40494-026-02509-4) |
| A Multi-task Multimodal Reasoning Framework for Oracle Bone Character Interpretation | Scientia Sinica Informationis 2026 | Semantic interpretation / multi-task reasoning | [Paper](https://doi.org/10.1360/SSI-2025-0551) |
...
| Oracle Character Image Retrieval by Combining Deep Neural Networks and Clustering Technology | IAENG IJCS 2020 | DNN + clustering retrieval/classification | [Paper](https://www.iaeng.org/IJCS/issues_v47/issue_2/IJCS_47_2_08.pdf) |
...
| Recognition of Oracle Bone Inscriptions by Using Two Deep Learning Models | IJDH 2021/2023 | YOLO + MobileNet pipeline | [arXiv](https://arxiv.org/abs/2105.00777) |
...
| UFCNet: Unsupervised Network Based on Fourier Transform and Convolutional Attention for Oracle Character Recognition | ML4AL @ ACL 2024 | Fourier/convolutional attention | [Paper](https://aclanthology.org/2024.ml4al-1.11/) |
...
| OBCTeacher: Resisting Labeled Data Scarcity in Oracle Bone Character Detection by Semi-supervised Learning | Information Processing & Management 2024 | Semi-supervised character detection/recognition | [Paper](https://doi.org/10.1016/j.ipm.2024.103864) |
...
| Historical Oracle Bone Character Recognition through Domain Transfer and Mutual Learning | Applied Soft Computing 2025 | Domain transfer / mutual learning | [Paper](https://doi.org/10.1016/j.asoc.2025.113031) |
...
| Oracle Character Recognition Using Universal Inverted Bottleneck and Inverse Image Frequency | IJDAR 2025 | Universal inverted bottleneck / inverse image frequency | [Paper](https://doi.org/10.1007/s10032-025-00512-2) |
...
| Dual Manifold Volume-Balanced Framework for Long-Tailed Oracle Character Recognition | PRCV 2025/2026 | Long-tailed recognition | [Paper](https://doi.org/10.1007/978-981-95-5676-2_40) |
...
| Rubbing Oracle Bone Character Recognition Based on Improved YOLOv8 Network | ICMA 2024 | YOLOv8 detection/recognition | [Paper](https://doi.org/10.1109/ICMA61710.2024.10633150) |
...
| Oracle Character Prototype-Guided Cyclic Disentanglement for Oracle Bone Inscriptions Detection | ICPRAI 2024/2025 | Prototype-guided cyclic disentanglement | [Paper](https://doi.org/10.1007/978-981-97-8705-0_14) |
...
| FDW-YOLO: An Improved YOLOv12 for Oracle Bone Inscriptions Detection | ICONIP 2025/2026 | YOLOv12 detection | [Paper](https://doi.org/10.1007/978-981-95-4378-6_18) |
| OracleDet: Structure-guided and Spatial-frequency Aware Detection of Oracle Bone Inscriptions in Complex Heritage Scenes | npj Heritage Science 2026 | Structure/spatial-frequency-aware detection | [Paper](https://www.nature.com/articles/s40494-026-02621-5) |
...
| Oracle Bone Inscription Image Retrieval Based on Improved ResNet Network | ICPR 2024/2025 | ResNet-based image retrieval | [Paper](https://doi.org/10.1007/978-3-031-78305-0_4) |
...
| Paper | Venue & Year | Focus | Links |
| :--- | :---: | :--- | :--- |
| Research on Key Technologies of the Computer Aided Rejoining of Oracle Bone Inscriptions | ICIFE 2010 | Freeman chain code / contour matching | [Paper](https://ieeexplore.ieee.org/document/5609279) |
| System Design for Computer Aided Rejoining of Bones/Tortoise Shells with Inscriptions Based on Contour Matching | ICCCT 2010 | Shape-function contour matching | [Paper](https://ieeexplore.ieee.org/document/5688700) |
...
| OBIFormer: A Fast Attentive Denoising Framework for Oracle Bone Inscriptions | Displays 2025 / arXiv 2025 | Denoising / restoration | [Paper](https://www.sciencedirect.com/science/article/abs/pii/S0141938225000964) / [arXiv](https://arxiv.org/abs/2504.13524) / [Code](https://github.com/OBI-Future/OBIFormer) |
...
## Ancient Script / Chinese Character Evolution Beyond OBI
...
| UniCalli: A Unified Diffusion Framework for Column-Level Generation and Recognition of Chinese Calligraphy | arXiv 2025 | Chinese calligraphy generation/recognition | [arXiv](https://arxiv.org/abs/2510.13745) |
...
- Please keep rows concise: one-line focus, stable links, and venue/year when known.
