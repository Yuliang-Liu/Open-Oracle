...
> Last updated: 2026-06-06. This file is a task-oriented bibliography for AI-assisted oracle bone inscription (OBI) and oracle bone script (OBS) processing. Rows are ordered by first public year within each section when a year is available. PRs are welcome.

## Contents

- [Surveys and Knowledge Resources](#surveys-and-knowledge-resources)
- [Datasets and Benchmarks](#datasets-and-benchmarks)
- [Decipherment and Interpretation](#decipherment-and-interpretation)
- [Multimodal Reasoning and Agent Systems](#multimodal-reasoning-and-agent-systems)
- [Recognition and Classification](#recognition-and-classification)
- [Detection and Segmentation](#detection-and-segmentation)
- [Retrieval and Matching](#retrieval-and-matching)
- [Rejoining and Association](#rejoining-and-association)
- [Restoration and Generation](#restoration-and-generation)
- [Broader Ancient Script and Character Evolution](#broader-ancient-script-and-character-evolution)

## Surveys and Knowledge Resources

| Paper or Resource | Venue and Year | Focus | Links |
| :--- | :---: | :--- | :--- |
| Oracle Bone Inscription Detection: A Survey of Oracle Bone Inscription Detection Based on Deep Learning Algorithm | AIIPCC 2019 | Detection architecture survey | [Paper](https://doi.org/10.1145/3371425.3371434) |
...
| A Comprehensive Survey of Oracle Character Recognition: Challenges, Datasets, Methodology, and Beyond | arXiv 2024, Pattern Recognition 2026 | Oracle character recognition survey | [Paper](https://doi.org/10.1016/j.patcog.2025.111824), [arXiv](https://arxiv.org/abs/2411.11354) |
...
| HWOBC: A Handwriting Oracle Bone Character Recognition Database | J. Phys.: Conf. Ser. 2020 | Handwritten OBC dataset with 83,245 character samples and 3,881 classes | [Paper](https://doi.org/10.1088/1742-6596/1651/1/012050), [Data](https://jgw.aynu.edu.cn/home/down/detail/index.html?sysid=2) |
...
| Oracle-MNIST: A Dataset of Oracle Characters for Benchmarking Machine Learning Algorithms | arXiv 2022, Scientific Data 2024 | 30,222 images, 10 categories | [Paper](https://www.nature.com/articles/s41597-024-02933-w), [arXiv](https://arxiv.org/abs/2205.09442), [Code](https://github.com/wm-bupt/oracle-mnist) |
...
| Oracle Bone Inscriptions Multi-modal Dataset | arXiv 2024, Scientific Data 2026 | OBIMD; rubbings, facsimiles, character annotations, and sentence annotations | [Paper](https://www.nature.com/articles/s41597-026-06967-0), [arXiv](https://arxiv.org/abs/2407.03900), [Code](https://github.com/libang1991/OBIMD), [HF](https://huggingface.co/datasets/KLOBIP/OBIMD) |
| OBI-Bench: Can LMMs Aid in Study of Ancient Script on Oracle Bones? | arXiv 2024, ICLR 2025 Spotlight | LMM benchmark for five OBI tasks | [OpenReview](https://openreview.net/forum?id=hL5jone2Oh), [arXiv](https://arxiv.org/abs/2412.01175), [Code](https://github.com/zijianchen98/OBI-Bench) |
...
| Mitigating Long-tail Distribution in Oracle Bone Inscriptions: Dataset, Model, and Benchmark | ACM MM 2025 | Oracle-P15K long-tail recognition benchmark | [Paper](https://dl.acm.org/doi/10.1145/3746027.3755067), [Code](https://github.com/OBI-Future/Oracle-P15K) |
...
| PictOBI-20k: Unveiling Large Multimodal Models in Visual Decipherment for Pictographic Oracle Bone Characters | arXiv 2025, ICASSP 2026 | 20k OBC-object image pairs and 15k+ multi-choice questions | [IEEE](https://ieeexplore.ieee.org/document/11462601), [arXiv](https://arxiv.org/abs/2509.05773), [Code](https://github.com/OBI-Future/PictOBI-20k) |
...
| AlphaOracle: Oracle Bone Script Decipherment via Human-Workflow-Inspired Deep Learning | The Innovation, Accepted 2026 | Human-workflow-inspired decipherment framework | [Code](https://github.com/Yuliang-Liu/AlphaOracle) |
...
## Multimodal Reasoning and Agent Systems
...
| Oracle Character Recognition Using Unsupervised Discriminative Consistency Network | arXiv 2023, Pattern Recognition 2024 | Unsupervised domain adaptation | [Paper](https://doi.org/10.1016/j.patcog.2023.110180), [arXiv](https://arxiv.org/abs/2312.06075) |
...
| OracleNet: Enhancing Oracle Bone Script Recognition with Adaptive Deformation and Texture-Structure Decoupling | npj Heritage Science 2025 | Adaptive deformation and disentanglement | [Paper](https://www.nature.com/articles/s40494-025-01839-z) |
...
| Spatial Pyramid Block for Oracle Bone Inscription Detection | ICSCA 2020 | Spatial-pyramid object detection | [Paper](https://doi.org/10.1145/3384544.3384561) |
...
| An Oracle Bone Inscription Detector Based on Multi-Scale Gaussian Kernels | Applied Mathematics 2021 | Anchor-free Gaussian-kernel detector | [Paper](https://doi.org/10.4236/am.2021.123014) |
| Oracle Bone Inscriptions Extraction by Using Weakly Supervised Instance Segmentation under Deep Network | ICISCAE 2021 | Weakly supervised instance segmentation | [Paper](https://doi.org/10.1109/ICISCAE52414.2021.9590705) |
...
| GCA-PVT-Net: Group Convolutional Attention and PVT Dual-Branch Network for Oracle Bone Drill Chisel Segmentation | Heritage Science 2024 | Drill-chisel segmentation | [Paper](https://www.nature.com/articles/s40494-024-01378-z) |
...
| Paper | Venue and Year | Focus | Links |
| :--- | :---: | :--- | :--- |
| Oracle Character Image Retrieval by Combining Deep Neural Networks and Clustering Technology | IAENG IJCS 2020 | DNN and clustering for oracle character retrieval | [Paper](https://www.iaeng.org/IJCS/issues_v47/issue_2/IJCS_47_2_08.pdf) |
...
| Component-Level Oracle Bone Inscription Retrieval | ICMR 2024 | Component-level retrieval and analysis | [Paper](https://dl.acm.org/doi/10.1145/3652583.3658116), [Code](https://github.com/hutt94/Component-Level-OBI-Retrieval) |
| A Cross-Font Image Retrieval Network for Recognizing Undeciphered Oracle Bone Inscriptions | arXiv 2024, ICIC 2025 | Cross-font retrieval | [arXiv](https://arxiv.org/abs/2409.06381) |
...
| FSMHNet: A Frequency-Aware and Stroke-Enhanced Multiscale Hash Network for Oracle Image Retrieval | ICONIP 2026 | Hash-based oracle image retrieval | [Paper](https://link.springer.com/chapter/10.1007/978-981-95-4097-6_8) |
...
| AI-Powered Oracle Bone Inscriptions Recognition and Fragments Rejoining | IJCAI 2020 | Recognition and fragment rejoining | [Paper](https://www.ijcai.org/proceedings/2020/779) |
...
| Multi-modal Ancient Scripts Recognition via Deep Learning with Data Homogenization and Augmentation | npj Heritage Science 2025 | Cross-modal data homogenization for ancient scripts | [Paper](https://www.nature.com/articles/s40494-025-02095-x) |
